...
#     }
#     return render(request, 'time.html', d)
def urlform(request):
...
def result(request):
    ...
    d = {
        ...
        'sport' : nb.score_without_log(nb.url(doc), 'スポーツ'),
        'entame' : nb.score_without_log(nb.url(doc), 'エンタメ'),
        'funny' : nb.score_without_log(nb.url(doc), 'おもしろ'),
        'japan' : nb.score_without_log(nb.url(doc), '国内'),
        'column' : nb.score_without_log(nb.url(doc), 'コラム'),
        'it' : nb.score_without_log(nb.url(doc), 'IT・科学'),
        'food' : nb.score_without_log(nb.url(doc), 'グルメ'),
    }
